     ...
     {!submitted ? (
       <form onSubmit={handleSubmit} className="space-y-4 text-white">
         <input
           ...
           required
           className="w-full p-2 bg-black border border-green-400 rounded text-base sm:text-lg"
         />
         ...
         <button
           ...
           className={`w-full bg-green-500 text-black font-bold py-2 px-4 rounded hover:bg-green-400 text-base sm:text-lg ${
